...
//  VERY IMPORTANT NOTE : these ranges are for lower illumination as seen for the real maze ....
...
// NOTE : VERY VERY IMPORTANT : these ranges are for the conditions found in the robotics lab with good lighting ...
...
// from gmm model
	...
	static const cv::Scalar RED_LOW1 = cv::Scalar(145, 110, 115);
	static const cv::Scalar RED_HIGH1 = cv::Scalar(181, 255, 255);

	static const cv::Scalar RED_LOW2 = cv::Scalar(0, 110, 125);
